...
-- class Tag (https://awesomewm.org/doc/api/classes/tag.html#Theme_variables)
theme.master_width_factor   = 2/3
theme.useless_gap   = dpi(8)
theme.gap_single_client  = true
theme.master_fill_policy  = "expand" -- ["expand", "*masterwidthfactor*"]
theme.master_count = 1
theme.column_count = 1

-- Class Client (https://awesomewm.org/doc/api/classes/client.html#Theme_variables)
...
-- Class wibar
-- (https://awesomewm.org/doc/api/classes/awful.wibar.html#Theme_variables)
...
-- (https://awesomewm.org/doc/api/classes/awful.widget.tasklist.html#Theme_variables)
